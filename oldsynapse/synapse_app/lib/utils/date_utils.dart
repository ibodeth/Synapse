...
class DateUtilsHelper {
  ...
  static DateTime? parseRssDate(String? dateStr) {
    ...
    // 1. Try generic HttpDate parsing (handles RFC1123 which is standard for RSS)
    // 1. Try generic HttpDate parsing (handles RFC1123 which is standard for RSS)
    // Removed HttpDate for web compatibility (dart:io not available)


    // 2. Manual parsing for RFC1123 (Web compatible)
